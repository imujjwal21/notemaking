...
<a href="#!" data-toggle="modal" data-target="#exampleModal" class="btn btn-light my-2 my-sm-0 mr-2" type="submit"> <i class="fa fa-user-circle-o" aria-hidden="true"></i> <%= user.getName()%></a>
<a href="LogoutServlet" class="btn btn-light my-2 my-sm-0 mr-2" type="submit"> <i class="fa fa-share-square"></i>  Logout</a>
...
<a href="login.jsp" class="btn btn-light my-2 my-sm-0 mr-2" type="submit"> <i class="fa fa-user-circle-o fa-spin" aria-hidden="true"></i> Login</a>
